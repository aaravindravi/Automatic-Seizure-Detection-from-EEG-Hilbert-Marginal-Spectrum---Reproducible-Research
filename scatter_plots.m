...
scatter(1:100,SEN_non(1,:),'ro')
hold on
scatter(1:100,SEN_sez(1,:),'b*')
title('Shannon')
box on
legend('NS','S','Location','southeast')
figure(2)
scatter(1:100,TEN_non(1,:),'ro')
hold on
scatter(1:100,TEN_sez(1,:),'b*')
title('Tsallis')
legend('NS','S','Location','southeast')
box on
figure(3)
scatter(1:100,REN_non(1,:),'ro')
hold on
scatter(1:100,REN_sez(1,:),'b*')
title('Renyi')
legend('NS','S','Location','southeast')
box on
